...
describe("Update Sale", () => {
	...
	it("should not be able to update a sale of a invalid restaurant", async () => {
		const user = await createUserUseCase.execute({
			name: "User Name",
			email: "user@email.com",
			password: "password",
	...
	it("should not be able to update a sale of a restaurant that does not belong to the user", async () => {
		const user = await createUserUseCase.execute({
			name: "User 1",
			email: "user@email.com",
			password: "password",
	...
	it("should not be able to update a inexistent sale", async () => {
		const user = await createUserUseCase.execute({
			name: "User",
			email: "user@email.com",
			password: "password",
	...
	it("should not be able to update a sale that does not belong to the restaurant", async () => {
		const user = await createUserUseCase.execute({
			name: "User",
			email: "user@email.com",
			password: "password",
	...
	it("should not be able to update a the sales name to a already existing one", async () => {
		const user = await createUserUseCase.execute({
			name: "User",
			email: "user@email.com",
			password: "password",
